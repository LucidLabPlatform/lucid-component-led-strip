...
def install_once() -> int:
    ...
    try:
        import lucid_component_led_strip
        pkg_path = Path(lucid_component_led_strip.__path__[0])
...
def main() -> None:
    ...
    ap = argparse.ArgumentParser(description="Install and start lucid-led-strip-helper (run as root)")
